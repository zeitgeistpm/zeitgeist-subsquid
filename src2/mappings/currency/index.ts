...
export const currencyDeposited = async (block: any, event: Event): Promise<HistoricalAccountBalance> => {
...
export const currencyWithdrawn = async (block: any, event: Event): Promise<HistoricalAccountBalance> => {
