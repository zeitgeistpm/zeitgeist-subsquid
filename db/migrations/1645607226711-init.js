module.exports = class init1645607226711 {
  name = 'init1645607226711'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "historical_account_balance" ("id" character varying NOT NULL, "account_id" text NOT NULL, "event" text NOT NULL, "asset_id" text NOT NULL, "amount" numeric NOT NULL, "balance" numeric NOT NULL, "block_number" integer NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_bfc701998dd9e45981c88f4d1af" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "historical_asset" ("id" character varying NOT NULL, "asset_id" text NOT NULL, "d_price" numeric, "d_qty" numeric NOT NULL, "price" numeric, "qty" numeric NOT NULL, "event" text NOT NULL, "block_number" integer NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_24bfbff0fb73bae4960d7301293" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "historical_market" ("id" character varying NOT NULL, "market_id" integer NOT NULL, "event" text NOT NULL, "status" text, "pool_id" integer, "report" jsonb, "resolved_outcome" text, "block_number" integer NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_8b5b3dfdac79a88102b94d55498" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "historical_pool" ("id" character varying NOT NULL, "pool_id" integer NOT NULL, "event" text NOT NULL, "ztg_qty" numeric NOT NULL, "volume" numeric, "block_number" integer NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_6ee31afe7b6dc3500a94effc951" PRIMARY KEY ("id"))`)
