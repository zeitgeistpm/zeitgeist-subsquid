module.exports = class Data1675941044884 {
  name = 'Data1675941044884'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "historical_market" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "event" text NOT NULL, "market_id" integer NOT NULL, "pool_id" integer, "resolved_outcome" text, "status" text, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_8b5b3dfdac79a88102b94d55498" PRIMARY KEY ("id"))`)
