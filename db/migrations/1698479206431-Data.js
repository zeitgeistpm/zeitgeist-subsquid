module.exports = class Data1698479206431 {
    name = 'Data1698479206431'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "pool" ("id" character varying NOT NULL, "base_asset" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "market_id" integer NOT NULL, "pool_id" integer NOT NULL, "scoring_rule" character varying(26) NOT NULL, "status" character varying(17) NOT NULL, "swap_fee" text, "total_subsidy" text, "total_weight" text NOT NULL, "volume" numeric NOT NULL, "weights" jsonb NOT NULL, "account_id" character varying, CONSTRAINT "PK_db1bfe411e1516c01120b85f8fe" PRIMARY KEY ("id"))`)
