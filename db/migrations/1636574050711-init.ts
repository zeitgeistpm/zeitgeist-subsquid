...
export class init1636574050711 implements MigrationInterface {
    name = 'init1636574050711'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "market" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by_id" character varying NOT NULL, "updated_at" TIMESTAMP DEFAULT now(), "updated_by_id" character varying, "deleted_at" TIMESTAMP, "deleted_by_id" character varying, "version" integer NOT NULL, "market_id" integer NOT NULL, "creator" character varying NOT NULL, "creation" character varying NOT NULL, "oracle" character varying NOT NULL, "slug" character varying, "question" character varying, "description" character varying, "market_type" jsonb NOT NULL, "period" jsonb NOT NULL, "scoring_rule" character varying NOT NULL, "status" character varying NOT NULL, "report" character varying, "resolved_outcome" character varying, "mdm" jsonb NOT NULL, CONSTRAINT "PK_1e9a2963edfd331d92018e3abac" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "market_history" ("id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_by_id" character varying NOT NULL, "updated_at" TIMESTAMP DEFAULT now(), "updated_by_id" character varying, "deleted_at" TIMESTAMP, "deleted_by_id" character varying, "version" integer NOT NULL, "market_id" character varying NOT NULL, "event" character varying NOT NULL, "status" character varying, "report" character varying, "resolved_outcome" character varying, "block_number" integer NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_be6923fa617384eeb8cc8ca3d10" PRIMARY KEY ("id"))`);
