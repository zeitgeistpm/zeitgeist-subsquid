module.exports = class Data1689772794114 {
    name = 'Data1689772794114'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "pool" ("id" character varying NOT NULL, "base_asset" text NOT NULL, "base_asset_qty" numeric NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "market_id" integer NOT NULL, "pool_id" integer NOT NULL, "scoring_rule" text NOT NULL, "status" character varying(17) NOT NULL, "swap_fee" text NOT NULL, "total_subsidy" text NOT NULL, "total_weight" text NOT NULL, "volume" numeric NOT NULL, "weights" jsonb NOT NULL, "account_id" character varying, CONSTRAINT "PK_db1bfe411e1516c01120b85f8fe" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "historical_market" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "by" text, "event" character varying(20) NOT NULL, "market_id" integer NOT NULL, "pool_id" integer, "outcome" jsonb, "resolved_outcome" text, "status" character varying(19) NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_8b5b3dfdac79a88102b94d55498" PRIMARY KEY ("id"))`)
