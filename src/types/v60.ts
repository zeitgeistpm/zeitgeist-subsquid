...
export type Asset = Asset_CategoricalOutcome | Asset_CombinatorialOutcomeLegacy | Asset_CombinatorialToken | Asset_ForeignAsset | Asset_ParimutuelShare | Asset_PoolShare | Asset_ScalarOutcome | Asset_Ztg
...
export interface Asset_CombinatorialOutcomeLegacy {
    __kind: 'CombinatorialOutcomeLegacy'
}

export interface Asset_CombinatorialToken {
    __kind: 'CombinatorialToken'
    value: Bytes
}
...
export const Asset: sts.Type<Asset> = sts.closedEnum(() => {
    return  {
        ...
        CombinatorialOutcomeLegacy: sts.unit(),
        CombinatorialToken: sts.bytes(),
