...
export const processor = new SubstrateBatchProcessor()
  ...
  .addEvent({
    name: [
      ...
      events.campaignAssets.burned.name,
      events.campaignAssets.issued.name,
      events.campaignAssets.transferred.name,
      events.combinatorialTokens.tokenMerged.name,
      events.combinatorialTokens.tokenRedeemed.name,
      events.combinatorialTokens.tokenSplit.name,
      events.court.courtOpened.name,
      events.court.jurorRevealedVote.name,
      ...
      events.neoSwaps.combinatorialPoolDeployed.name,
      events.neoSwaps.comboBuyExecuted.name,
      events.neoSwaps.comboSellExecuted.name,
